...
export function Contact() {
      ...
      setFormState(prev => {
        ...
        if (item) {
          ...
          if (lowerItem.includes('tta') || lowerItem.includes('panel')) {
            ...
            mappedType = 'Lucy RMU';
          } else if (lowerItem.includes('css') || lowerItem.includes('substation')) {
            mappedType = 'Lucy CSS';
          } else if (lowerItem.includes('mepf') || lowerItem.includes('consultancy')) {
            mappedType = 'MEPF Consultancy';
          } else if (lowerItem.includes('epc') || lowerItem.includes('turnkey') || lowerItem.includes('infrastructure')) {
  ...
  return (
    <div className="bg-background text-on-background font-body min-h-screen pt-[56px] sm:pt-[64px] md:pt-[80px]">
      ...
      <section className="relative bg-[#08090c] text-white py-16 md:py-24 overflow-hidden border-b border-outline-variant/30 flex flex-col justify-center">
        ...
        <div aria-hidden className="absolute inset-0 pointer-events-none z-0">
          <div className="absolute -top-[30%] -left-[10%] w-[65%] h-[80%] rounded-full bg-accent/10 blur-[100px]" />
          <div className="absolute -bottom-[30%] -right-[10%] w-[60%] h-[80%] rounded-full bg-primary/5 blur-[120px]" />
        </div>
        ...
        <div className="max-w-[1440px] mx-auto relative z-10 w-full px-8 md:px-16">
          <div className="max-w-4xl space-y-6">
            ...
            >
              We provide high-compliance power solutions, MEPF engineering, and project commissioning across India. Talk to our specialists today.
            </motion.p>
          </div>
        </div>
      </section>
            ...
            <div className="sticky top-32 space-y-8">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="font-label-caps text-[11px] text-accent tracking-[0.22em] uppercase font-bold">Connect Directly</span>
                </div>
                <h2 className="font-headline text-3xl font-bold text-on-surface uppercase tracking-tight">Our Offices</h2>
              </div>
              ...
              <div className="border border-outline-variant/30 bg-surface-container-low p-8 relative overflow-hidden">
                ...
                <ul className="space-y-6">
                  ...
                  <li className="flex items-start gap-4">
                    <span className="material-symbols-outlined text-accent text-[24px] shrink-0 mt-0.5">location_on</span>
                    <div>
                      <span className="font-label-caps text-[9px] text-secondary/50 tracking-[0.15em] uppercase block mb-1 font-bold">Office Address</span>
                      <p className="font-body text-[14px] text-on-surface leading-relaxed">
                        Ahmedabad, Gujarat, India<br/>
                        <span className="text-[12px] text-secondary/60">(Full office address details pending from client)</span>
                      </p>
                    </div>
                  </li>
                  ...
                  {/* Phone */}
                  <li className="flex items-start gap-4">
                    <span className="material-symbols-outlined text-accent text-[24px] shrink-0 mt-0.5">call</span>
                    <div>
                      <span className="font-label-caps text-[9px] text-secondary/50 tracking-[0.15em] uppercase block mb-1 font-bold">Phone Connection</span>
                      <p className="font-body text-[14px] text-on-surface">
                        +91 XXXXX XXXXX<br/>
                        <span className="text-[12px] text-secondary/60">(Official contact number pending)</span>
                      </p>
                    </div>
                  </li>
                  ...
                  {/* Email */}
                  <li className="flex items-start gap-4">
                    <span className="material-symbols-outlined text-accent text-[24px] shrink-0 mt-0.5">mail</span>
                    <div>
                      <span className="font-label-caps text-[9px] text-secondary/50 tracking-[0.15em] uppercase block mb-1 font-bold">Technical Enquiries</span>
                      <a href="mailto:info@arihantaa.com" className="font-body text-[14px] text-on-surface hover:text-accent transition-colors">
                        info@arihantaa.com
                      </a>
                    </div>
                  </li>
                  ...
                  {/* Hours */}
                  <li className="flex items-start gap-4">
                    <span className="material-symbols-outlined text-accent text-[24px] shrink-0 mt-0.5">schedule</span>
                    <div className="flex-1">
                      <span className="font-label-caps text-[9px] text-secondary/50 tracking-[0.15em] uppercase block mb-2.5 font-bold">Business Hours</span>
                      
                      {/* Day block badges */}
                      <div className="flex items-center gap-1.5 mb-2.5">
                        {['M', 'T', 'W', 'T', 'F', 'S'].map((day, idx) => (
                          <div key={idx} className="w-6 h-6 flex items-center justify-center text-[10px] font-mono font-bold bg-accent/10 text-accent border border-accent/20 select-none rounded-none" title="Open">
                            {day}
                          </div>
                        ))}
                        <div className="w-6 h-6 flex items-center justify-center text-[10px] font-mono font-bold bg-white/5 text-accent border border-accent/20 select-none rounded-none" title="Closed">
                          S
                        </div>
                      </div>
                      ...
                      <div className="font-body text-[13.5px] text-on-surface leading-relaxed">
                        <span className="text-accent font-bold">9:00 AM – 6:30 PM</span>
                        <span className="text-secondary/60 text-[12px] ml-2 font-medium">(Monday – Saturday)</span>
                      </div>
                    </div>
                  </li>
                </ul>
            ...
            <form className="space-y-8" onSubmit={handleFormSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 group relative">
                  <label className="font-label-caps text-[9.5px] uppercase tracking-[0.2em] font-semibold text-secondary/65 group-focus-within:text-accent transition-colors block" htmlFor="fullName">Full Name *</label>
                  <input 
                    type="text" 
                    id="fullName" 
                    required 
                ...
                {/* Company Name */}
                <div className="space-y-2 group relative">
                  <label className="font-label-caps text-[9.5px] uppercase tracking-[0.2em] font-semibold text-secondary/65 group-focus-within:text-accent transition-colors block" htmlFor="company">Company Name</label>
                  <input 
                    type="text" 
                    id="company" 
                ...
                {/* Phone */}
                <div className="space-y-2 group relative">
                  <label className="font-label-caps text-[9.5px] uppercase tracking-[0.2em] font-semibold text-secondary/65 group-focus-within:text-accent transition-colors block" htmlFor="phone">Phone Number *</label>
                  <input 
                    type="tel" 
                    id="phone" 
                    required 
                ...
                {/* Email */}
                <div className="space-y-2 group relative">
                  <label className="font-label-caps text-[9.5px] uppercase tracking-[0.2em] font-semibold text-secondary/65 group-focus-within:text-accent transition-colors block" htmlFor="email">Email Address *</label>
                  <input 
                    type="email" 
                    id="email" 
                    required 
                ...
                <div className="space-y-2 group relative md:col-span-2">
                  <label className="font-label-caps text-[9.5px] uppercase tracking-[0.2em] font-semibold text-secondary/65 block" htmlFor="enquiryType">Enquiry Type *</label>
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="L&T TTA Panel">L&T Brand TTA Panel</option>
                      <option value="Lucy RMU">Lucy Brand RMU</option>
                      <option value="Lucy CSS">Lucy Brand CSS</option>
                      <option value="MEPF Consultancy">MEPF Consultancy</option>
                      <option value="EPC Contracting">EPC Contracting</option>
                      <option value="Other">Other / General Enquiry</option>
                    </select>
                    <span className="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-secondary/60 pointer-events-none text-[22px]">expand_more</span>
                  </div>
                </div>

                {/* Project Location */}
                <div className="space-y-2 group relative md:col-span-2">
                  <label className="font-label-caps text-[9.5px] uppercase tracking-[0.2em] font-semibold text-secondary/65 group-focus-within:text-accent transition-colors block" htmlFor="location">Project Location (City / State)</label>
                  <input 
                    type="text" 
                    id="location" 
                ...
                {/* Message */}
                <div className="space-y-2 group relative md:col-span-2">
                  <label className="font-label-caps text-[9.5px] uppercase tracking-[0.2em] font-semibold text-secondary/65 group-focus-within:text-accent transition-colors block" htmlFor="message">Message Brief *</label>
                  <textarea 
                    id="message" 
                    rows="5" 
                    required
              ...
              <div className="pt-6 border-t border-outline-variant/20 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-6">
                <span className="text-[12px] text-secondary/60 max-w-sm leading-relaxed">
                  We typically respond within 1 business day. Your information is kept confidential and never shared with third parties.
                </span>
                  ...
                  <AnimatePresence>
                    {submitSuccess && (
                      ...
                      >
                        ...
                        <span className="font-label-caps text-[10px] uppercase tracking-wider">BRIEF SUBMITTED</span>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </div>
