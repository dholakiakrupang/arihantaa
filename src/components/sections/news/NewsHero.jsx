...
export function NewsHero() {
  return (
    ...
    >
      ...
      >
        <motion.img
          src="/images/project-metro.png"
          alt="News & Intelligence Center"
        ...
        >
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-label-caps text-[9px] text-accent tracking-[0.22em] uppercase font-bold">INTELLIGENCE CENTER</span>
          </div>
            ...
            <div className="w-full lg:w-[52%] flex flex-col justify-center py-10 lg:py-16 flex-1 lg:pr-16">
              <div className="flex flex-col gap-0">
                ...
                >
                  ...
                  <span className="font-label-caps text-[10px] text-white/35 tracking-[0.2em] uppercase">News</span>
                </motion.nav>
                ...
                >
                  ...
                  <span className="font-label-caps text-[10px] text-accent tracking-[0.28em] uppercase font-bold">Intelligence</span>
                </motion.div>
                ...
                >
                  ...
                  <span className="block text-white" style={{ fontSize: 'clamp(36px, 4.2vw, 68px)' }}>Intelligence.</span>
                </motion.h1>
