...
export function ProductSectionDetail({
  id,
  title,
  eyebrow,
  description,
        ...
        >
          ...
          >
            ...
            {badgeLabel && badgeValue && (
              ...
              >
                <span className="block font-headline text-[10px] tracking-[0.15em] uppercase opacity-85 font-bold">
                  {badgeLabel}
                </span>
                <span className="block font-headline text-[16px] font-black leading-none mt-0.5">
                  {badgeValue}
                </span>
              </div>
            )}
          ...
          >
            ...
            {/* Title */}
            <h2 className="font-headline text-[26px] sm:text-[36px] lg:text-[54px] leading-[1.05] font-black tracking-tighter text-on-surface mb-5 uppercase">
              {title}
            </h2>
            ...
            <div className="space-y-4 mb-8">
              {description.map((para, i) => (
                <p
                  key={i}
                  className="font-body text-[15px] md:text-[16px] leading-relaxed text-secondary font-light"
                >
                  {para}
                </p>
              ))}
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 font-label-caps text-[11px] tracking-[0.15em] uppercase text-accent border-b border-accent pb-0.5 hover:gap-4 transition-all duration-300 w-fit group font-bold"
            >
              {productTo.startsWith("/products/")
                ? "View Product Range"
                : "Explore Solutions"}
