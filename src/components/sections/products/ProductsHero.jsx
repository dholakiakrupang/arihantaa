      ...
      >
        ...
        >
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-label-caps text-[9px] text-accent tracking-[0.22em] uppercase font-bold">OUR SOLUTIONS</span>
          </div>
          <p className="font-headline text-[20px] font-black uppercase text-white leading-tight tracking-tight max-w-[260px]">
            Precision-Built for Mission-Critical Environments
          </p>
        </motion.div>
      </motion.div>
            ...
            <div className="w-full lg:w-[52%] flex flex-col justify-center py-10 lg:py-16 flex-grow lg:pr-16">
              <div className="flex flex-col gap-0">
                ...
                >
                  ...
                  <span className="block text-white" style={{ fontSize: 'clamp(36px, 4.2vw, 68px)' }}>Infrastructure.</span>
                </motion.h1>
