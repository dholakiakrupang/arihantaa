...
/**
 * ServicesHero — same split-screen layout as ProductsHero:
 * dark left panel with animated content + diagonal clip-path + right image.
 */
      ...
      <div className="relative w-full md:w-[55%] flex items-center px-8 py-16 md:py-24 md:pl-16 md:pr-20 bg-inverse-surface z-10">
        ...
        <div className="w-full max-w-[520px]">
          ...
          >
            ...
            <span className="font-label-caps text-[10px] text-surface-variant tracking-[0.2em] uppercase">Services</span>
          </motion.nav>
          ...
          >
            Engineering Services Built for Critical Infrastructure
          </motion.h1>
