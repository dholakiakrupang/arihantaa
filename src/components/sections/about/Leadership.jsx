          ...
          <div>
            <Reveal delay={0}>
              <div className="grid grid-cols-12 gap-8 items-start">
                <div className="col-span-5 aspect-[3/4] overflow-hidden grayscale hover:grayscale-0 transition-all duration-700">
                  <img 
                ...
                <div className="col-span-7 pt-4 border-l-4 border-primary pl-8">
                  <h4 className="font-headline text-2xl font-bold mb-1">Kaushik Jariwala</h4>
                  <p className="eyebrow !mb-4">Founder & Managing Director</p>
                  ...
                  <a className="inline-flex items-center gap-2 text-[11px] font-black tracking-widest hover:gap-4 transition-all" href="#">
          ...
          <div>
            <Reveal delay={0.15}>
              <div className="grid grid-cols-12 gap-8 items-start">
                ...
                <div className="col-span-7 pt-4 border-l-4 border-primary pl-8">
                  <h4 className="font-headline text-2xl font-bold mb-1">Lilam Shah</h4>
                  <p className="eyebrow !mb-4">Director - Technical</p>
